...
class Pasien extends CI_Controller {
	...
	public function dokter_form_pasien($id_pasien = null){
		$data['content'] 	= 'dokter/pasien/detail_pasien';
	...
	{	
		if($this->input->post('form_type') == "INPUT"){;
			...
			$this->M_pasien->Id_Resep($id_pasien);
	...
	public function save_pasien_dokter()
	{	
		if($this->input->post('form_type') == "INPUT"){;
			$id_pasien = $this->M_pasien->_Create_Pasien();
			redirect(base_url('pasien'));
			...
			$id_pasien = $this->input->post('id_pasien');
			$this->M_pasien->_Update_Pasien_Dokter($id_pasien);
			redirect(base_url('dokter/pasien'));
		}
	}
