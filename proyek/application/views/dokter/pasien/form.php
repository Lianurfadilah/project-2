    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form class="form-horizontal form-label-left" role="form" id="form_pasien" method="post" action="<?php echo base_url('admin/pasien/save_pasien'); ?>"  enctype="multipart/form-data">
              ...
              <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-3">
                  ...
                  <a href="'.base_url('admin/pasien').'" class="btn btn-primary">Kembali</a>
