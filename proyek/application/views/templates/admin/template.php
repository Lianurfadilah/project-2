          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo base_url().'assets/';?>layout/images/admin.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo base_url('pasien'); ?>"><i class="fa fa-database"></i> Data Pasien <span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a href="<?php echo base_url('obat'); ?>"><i class="fa fa-database"></i> Data Obat </a>
                </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url().'assets/';?>layout/images/admin.png" alt="">Admin
