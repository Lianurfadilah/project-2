        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url('Dashboard/data_obat'); ?>" class="site_title"><i class="fa fa-paw"></i> <span>Dokter Jamil</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo base_url().'assets/';?>layout/images/apotek.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url('apoteker'); ?>"><i class="fa fa-dashboard"></i> Dashboard </a></li>
                  </li>
                  <li><a href="<?php echo base_url('Master_obat'); ?>"><i class="fa fa-database"></i> Data Obat </a>
                </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url().'assets/';?>layout/images/apotek.png" alt="">Apoteker
