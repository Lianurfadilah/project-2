          <div class="right_col" role="main">
            <div class="">    
              <div class="col-md-12 col-sm-12 col-xs-12 pull-right">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><a class="btn btn-primary btn-sm" href="<?php echo base_url('pasien/form'); ?>"><i class="fa fa-plus"></i>Tambah  Data Pasien</a></h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="center">
                              <center>
                                <a href="<?php echo base_url('pasien/form/'.$pasien['id_pasien']); ?>" class="btn btn-warning btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
