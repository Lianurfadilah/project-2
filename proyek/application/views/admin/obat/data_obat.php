                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php $i=1; foreach($obat as $stok_obat) { ?>
                        <tr class="odd gradeX">
                            ...
                            <td class="center">
                              <center>
                                ...
                                <a href="<?php echo base_url('obat/delete/'.$stok_obat['id_obat']); ?>" class="btn btn-danger btn-xs" onClick="return confirm('Yakin ingin menghapus Data Pasien yang bernama <?php echo (ucwords($stok_obat['nama_obat'])); ?> ini?')" title="Delete"><i class="fa fa-trash"></i></a>
                              </center>
                            </td>
                        </tr>
                        <?php $i++; } ?>
